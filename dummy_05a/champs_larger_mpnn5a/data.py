...
def run_check_0():
    ...
    xyz_dir = '/root/share/project/kaggle/2019/champs_scalar/data/structure/xyz'
    name =[
        'dsgdb9nsd_000001',
        'dsgdb9nsd_000002',
        'dsgdb9nsd_000005',
...
def run_make_split():
    ...
    split_dir = '/root/share/project/kaggle/2019/champs_scalar/data/split'

    csv_file = '/root/share/project/kaggle/2019/champs_scalar/data/csv/train.csv'
