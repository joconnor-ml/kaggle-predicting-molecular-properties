...
class ChampsDatasetTargetSubset(InMemoryDataset):  # todo, drop targets not in desired target subset.
    num_classes = 1
    csv_file = "/mnt/kaggle-predicting-molecular-properties/data/csv/train.csv"
    graph_dir = "/mnt/kaggle-predicting-molecular-properties/data/graphs/"
    ...
    @property
    def processed_file_names(self):
        return ['champs.target_subset_{}.dataset'.format("_".join(self.target_classes))]
